          ...
          if (user) {
            if (true) {
              ...
              return res.render("userLogin", {
                msgErrors: {
                  password: { msg: "Email o contraseña incorrecta" },
                },
                old: req.body,
            ...
            return res.render("userLogin", {
              msgErrors: {
                user_name: { msg: "Email o contraseña incorrecta" },
              },
              old: req.body,
              userSession: userSession,
            });
    ...
    if (errors.isEmpty()) {
        ...
        .then((existName) => {
          if (existName) {
            return res.render("userRegister", {
              msgErrors: { user_name: { msg: "Ese nombre ya existe" } },
              old: req.body,
              userSession: userSession,
            });
          }
      ...
      db.User.findOne({
        ...
        .then((existEmail) => {
          if (existEmail) {
            return res.render("userRegister", {
              msgErrors: { email: { msg: "Ese email ya existe" } },
              old: req.body,
              userSession: userSession,
            });
          }
      ...
      if (req.body.admin) {
        if (req.body.adminCode === "123") {
          ...
          return res.render("userRegister", {
            msgErrors: { adminCode: { msg: "El codigo no corresponde" } },
            old: req.body,
            userSession: userSession,
          });
        }
